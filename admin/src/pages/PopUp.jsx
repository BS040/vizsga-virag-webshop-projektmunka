    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 shadow-md">
                <h2 className="text-lg font-bold text-center">Biztosan inaktiválod ezt a felhasználót?</h2>
                <div className="flex justify-center mt-4 space-x-4"> {/* Center buttons with space in between */}
